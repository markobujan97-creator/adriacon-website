...
export const faqs = [
  ...
  },
  {
    ...
    a: 'Paketfinder, Business Radar und Jahreskurs rechnen vollständig in Ihrem Browser. Es wird nichts an uns übermittelt, solange Sie nicht aktiv das Kontaktformular senden.',
  },
] as const;
